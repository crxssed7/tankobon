...
urlpatterns = [
    ...
    path('manga/all/completed/', views.all_manga_completed, name='all_manga_completed'),
    path('manga/all/releasing/', views.all_manga_releasing, name='all_manga_releasing'),
